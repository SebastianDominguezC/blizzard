...
impl<T: Game<K, I>, K, I> Application<T, K, I> {
    pub fn create(game: T, shared_state: K, input: I) -> Application<T, K, I> {
        // Start logging
        initialize_logging();
...
pub fn create_app<T: Game<K, I>, K, I>(game: T, shared_state: K, input: I) -> Application<T, K, I> {
    Application::create(game, shared_state, input)
}
